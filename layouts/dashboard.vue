<template>
  <div>
    ...
    <div class="fixed inset-0 flex z-40 md:hidden" role="dialog" aria-modal="true" v-if="isShowSidebar"
         @click="!isShowSidebar">
      <!--
        ...
        Leaving: "transition-opacity ease-linear duration-300"
          ...
          To: "opacity-0"
      -->
      <div class="fixed inset-0 bg-gray-600 bg-opacity-75" aria-hidden="true" @click="isShowSidebar = false"></div>
